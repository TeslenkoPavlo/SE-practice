...
8. Члени команди (розробник, менеджер продукту з допомогою інших) будують **[діаграму прецедентів](https://www.draw.io/?mode=github)** для майбутньої системи (посилання створить нову діаграму в *draw.io* в GitHub-режимі). Готову діаграму слід покласти в цій теці (````1. Envisioning````)
